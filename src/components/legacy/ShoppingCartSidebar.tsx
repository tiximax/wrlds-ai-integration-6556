/*
  LEGACY: ShoppingCartSidebar (dựa trên CartContext cũ)
  - UI giỏ hàng nâng cao (CartContext) hiện không sử dụng; SimpleCartSidebar đang là mặc định.
  - Giữ lại để tham khảo hoặc dùng trong tương lai.
*/
